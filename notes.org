...
(these are just observations which should be appropriately filed)

What we didn't expect.
Almost no written arguments opposing open source.

DOD policy had more apparent gravity than OMB policy, despite having a
smaller audience.

The folks who started the fight didn't end it.
No discussion of mandates, anywhere. Remarkable restraint!

What we should have expected.
A few key people keep showing up.

The mid-2008 OSS Census declares that gov't is the largest user of
OSS, just four years after the big policies were released. DOD policy
probbly ratified what was already happening. Why else would they write
a policy?
